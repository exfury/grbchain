...
import (
	...
	"github.com/exfury/grbchain/app/rpc/backend"
	cosmos_context "github.com/exfury/grbchain/libs/cosmos-sdk/client/context"
	"github.com/exfury/grbchain/libs/cosmos-sdk/client/flags"
	cmserver "github.com/exfury/grbchain/libs/cosmos-sdk/server"
	cosmost "github.com/exfury/grbchain/libs/cosmos-sdk/store/types"
	sdk "github.com/exfury/grbchain/libs/cosmos-sdk/types"
	"github.com/exfury/grbchain/x/evm/watcher"

	"github.com/exfury/grbchain/app/rpc"
	"github.com/exfury/grbchain/app/rpc/types"
...
func (suite *RPCTestSuite) SetupTest() {
	...
	// set grbchaincli path
	cliDir, err := ioutil.TempDir("", ".grbchaincli")
	if err != nil {
		panic(err)
	}
	...
	// set grbchaind path
	serverDir, err := ioutil.TempDir("", ".grbchaind")
	if err != nil {
		panic(err)
	}
...
func (suite *RPCTestSuite) TestEth_GetBlockByHash() {
	...
	// TODO: grbchain only supports the block query with txs' hash inside no matter what the second bool argument is.
