...
import (
	...
	types3 "github.com/exfury/grbchain/app/types"
	...
	types2 "github.com/exfury/grbchain/x/evm/types"
...
func SetupWithGenesisAccounts(b testing.TB, db dbm.DB, genAccs []authexported.GenesisAccount) *app.OKBChainApp {
	...
	exfuryApp.BeginBlock(abci.RequestBeginBlock{Header: abci.Header{Height: okxApp.LastBlockHeight() + 1}})
