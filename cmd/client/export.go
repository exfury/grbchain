...
import (
	...
	"github.com/exfury/grbchain/app/crypto/ethkeystore"
	"github.com/exfury/grbchain/app/crypto/hd"
	"github.com/exfury/grbchain/libs/cosmos-sdk/client/flags"
	"github.com/exfury/grbchain/libs/cosmos-sdk/client/input"
...
func ExportEthCompCommand() *cobra.Command {
	return &cobra.Command{
		...
		Short:  "Export an Ethereum private keystore directory (This command has been deprecated,please use 'grbchaincli keys export-eth-keystore')",
		Hidden: true,
	...
	The parameters of scrypt encryption algorithm is StandardScryptN and StandardScryptN`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return fmt.Errorf("This command has been deprecated,please use 'grbchaincli keys export-eth-keystore'")
		},
	}
}
