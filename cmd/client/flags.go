...
import (
	...
	"github.com/exfury/grbchain/app/rpc/namespaces/eth"
	"github.com/exfury/grbchain/app/rpc/namespaces/eth/filters"
	"github.com/exfury/grbchain/app/rpc/websockets"
	"github.com/exfury/grbchain/app/types"
	...
	"github.com/exfury/grbchain/libs/tendermint/libs/automation"
	tmtypes "github.com/exfury/grbchain/libs/tendermint/types"
	tmdb "github.com/exfury/grbchain/libs/tm-db"
...
func RegisterAppFlag(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(config.FlagPprofUseCGroup, false, "Use cgroup when grbchaind run in docker")
