...
import (
	...
	srvconfig "github.com/exfury/grbchain/libs/cosmos-sdk/server/config"
...
Note, strict routability for addresses is turned off in the config file.`,
		...
		Example: "grbchaind testnet --v 4 --keyring-backend test --output-dir ./output --starting-ip-address 192.168.10.2",
	...
	cmd.Flags().String(flagNodeDaemonHome, "grbchaind", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "grbchaincli", "Home directory of the node's cli configuration")
...
func InitTestnet(
	...
	if chainID == "" {
		chainID = fmt.Sprintf("grbchain-%d", tmrand.Int63n(9999999999999)+1)
	}
