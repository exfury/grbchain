...
import (
	...
	"github.com/exfury/grbchain/app/codec"
	"github.com/exfury/grbchain/app/crypto/ethsecp256k1"
	chain "github.com/exfury/grbchain/app/types"
	"github.com/exfury/grbchain/cmd/client"
	sdkclient "github.com/exfury/grbchain/libs/cosmos-sdk/client"
	"github.com/exfury/grbchain/libs/cosmos-sdk/client/flags"
	clientkeys "github.com/exfury/grbchain/libs/cosmos-sdk/client/keys"
	clientrpc "github.com/exfury/grbchain/libs/cosmos-sdk/client/rpc"
	sdkcodec "github.com/exfury/grbchain/libs/cosmos-sdk/codec"
	"github.com/exfury/grbchain/libs/cosmos-sdk/crypto/keys"
	...
	authcmd "github.com/exfury/grbchain/libs/cosmos-sdk/x/auth/client/cli"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/auth/client/utils"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/bank"
	tmamino "github.com/exfury/grbchain/libs/tendermint/crypto/encoding/amino"
	"github.com/exfury/grbchain/libs/tendermint/crypto/multisig"
	"github.com/exfury/grbchain/libs/tendermint/libs/cli"
	evmtypes "github.com/exfury/grbchain/x/evm/types"
	tokencmd "github.com/exfury/grbchain/x/token/client/cli"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "grbchaincli",
		Short: "Command line interface for interacting with grbchaind",
	}
	...
	// Add flags and prefix all env exposed with GRBCHAIN
