...
import (
	...
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/cachemulti"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/dbadapter"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/flatkv"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/iavl"
	sdkmaps "github.com/exfury/grbchain/libs/cosmos-sdk/store/internal/maps"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/mem"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/mpt"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/tracekv"
	"github.com/exfury/grbchain/libs/cosmos-sdk/store/transient"
	...
	iavltree "github.com/exfury/grbchain/libs/iavl"
	"github.com/exfury/grbchain/libs/iavl/config"
	"github.com/exfury/grbchain/libs/system/trace"
	"github.com/exfury/grbchain/libs/system/trace/persist"
	abci "github.com/exfury/grbchain/libs/tendermint/abci/types"
	cfg "github.com/exfury/grbchain/libs/tendermint/config"
	"github.com/exfury/grbchain/libs/tendermint/crypto/merkle"
	"github.com/exfury/grbchain/libs/tendermint/crypto/tmhash"
	tmlog "github.com/exfury/grbchain/libs/tendermint/libs/log"
...
func (rs *Store) loadVersion(ver int64, upgrades *types.StoreUpgrades) error {
	...
	if len(rs.pruneHeights) > maxPruneHeightsLength {
		return fmt.Errorf("Pruned heights length <%d> exceeds <%d>, "+
			...
			"<grbchaind data prune-compact all --home your_okbchaind_home_directory> before running okbchaind",
