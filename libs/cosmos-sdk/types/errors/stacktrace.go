...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/exfury/grbchain/libs/cosmos-sdk/types/errors.Wrap",
		"github.com/exfury/grbchain/libs/cosmos-sdk/types/errors.Wrapf",
		"github.com/exfury/grbchain/libs/cosmos-sdk/types/errors.WithType",
