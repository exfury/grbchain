...
import (
	...
	blockindex "github.com/exfury/grbchain/libs/tendermint/state/indexer"
	bloxkindexnull "github.com/exfury/grbchain/libs/tendermint/state/indexer/block/null"

	"github.com/exfury/grbchain/libs/tendermint/global"
	...
	bcv0 "github.com/exfury/grbchain/libs/tendermint/blockchain/v0"
	bcv1 "github.com/exfury/grbchain/libs/tendermint/blockchain/v1"
	bcv2 "github.com/exfury/grbchain/libs/tendermint/blockchain/v2"
	cfg "github.com/exfury/grbchain/libs/tendermint/config"
	"github.com/exfury/grbchain/libs/tendermint/consensus"
	cs "github.com/exfury/grbchain/libs/tendermint/consensus"
	"github.com/exfury/grbchain/libs/tendermint/crypto"
	"github.com/exfury/grbchain/libs/tendermint/evidence"
	"github.com/exfury/grbchain/libs/tendermint/libs/log"
	tmpubsub "github.com/exfury/grbchain/libs/tendermint/libs/pubsub"
	"github.com/exfury/grbchain/libs/tendermint/libs/service"
	mempl "github.com/exfury/grbchain/libs/tendermint/mempool"
	"github.com/exfury/grbchain/libs/tendermint/p2p"
	"github.com/exfury/grbchain/libs/tendermint/p2p/pex"
	"github.com/exfury/grbchain/libs/tendermint/privval"
	"github.com/exfury/grbchain/libs/tendermint/proxy"
	rpccore "github.com/exfury/grbchain/libs/tendermint/rpc/core"
	ctypes "github.com/exfury/grbchain/libs/tendermint/rpc/core/types"
	grpccore "github.com/exfury/grbchain/libs/tendermint/rpc/grpc"
	rpcserver "github.com/exfury/grbchain/libs/tendermint/rpc/jsonrpc/server"
	sm "github.com/exfury/grbchain/libs/tendermint/state"
	blockindexer "github.com/exfury/grbchain/libs/tendermint/state/indexer/block/kv"
	"github.com/exfury/grbchain/libs/tendermint/state/txindex"
	"github.com/exfury/grbchain/libs/tendermint/state/txindex/kv"
	"github.com/exfury/grbchain/libs/tendermint/state/txindex/null"
	"github.com/exfury/grbchain/libs/tendermint/store"
	"github.com/exfury/grbchain/libs/tendermint/types"
	tmtime "github.com/exfury/grbchain/libs/tendermint/types/time"
	"github.com/exfury/grbchain/libs/tendermint/version"
)
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewReactor(addrBook,
		&pex.ReactorConfig{
			...
			// https://github.com/exfury/grbchain/libs/tendermint/issues/3523
...
func (n *Node) startRPC() ([]net.Listener, error) {
	...
	// See https://github.com/exfury/grbchain/libs/tendermint/issues/3435
