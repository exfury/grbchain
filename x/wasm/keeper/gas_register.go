...
const (
	...
	// Cosmos SDK reference costs can be found here: https://github.com/exfury/grbchain/blob/v0.1.0/libs/cosmos-sdk/store/types/gas.go#L171-L181.
	//
...
type WasmGasRegisterConfig struct {
	...
	// SDK reference costs can be found here: https://github.com/exfury/grbchain/blob/v0.1.0/libs/cosmos-sdk/store/types/gas.go#L171-L181
