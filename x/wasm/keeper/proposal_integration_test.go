...
//	"testing"
//
//	"github.com/exfury/grbchain/libs/cosmos-sdk/x/params/client/utils"
//
...
//	"github.com/exfury/grbchain/libs/cosmos-sdk/x/params/types/proposal"
...
func (suite *ProposalTestSuite) TestModifyNextBlockUpdateProposal() {
	...
	for _, tc := range testCases {
		suite.Run(tc.msg, func() {
			...
			suite.app.BeginBlock(abci.RequestBeginBlock{Header: abci.Header{ChainID: "grbchain-67", Height: 1, Time: time.Now()}})
