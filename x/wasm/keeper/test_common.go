...
import (
	...
	"github.com/exfury/grbchain/x/wasm/keeper/testdata"
	...
	cosmoscryptocodec "github.com/exfury/grbchain/libs/cosmos-sdk/x/auth/ibc-tx"
	ibc_tx "github.com/exfury/grbchain/libs/cosmos-sdk/x/auth/ibc-tx"
	authkeeper "github.com/exfury/grbchain/libs/cosmos-sdk/x/auth/keeper"
	authtypes "github.com/exfury/grbchain/libs/cosmos-sdk/x/auth/types"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/bank"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/capability"
	...
	crisistypes "github.com/exfury/grbchain/libs/cosmos-sdk/x/crisis"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/evidence"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/mint"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/slashing"
	slashingtypes "github.com/exfury/grbchain/libs/cosmos-sdk/x/slashing"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/supply"
	"github.com/exfury/grbchain/libs/cosmos-sdk/x/upgrade"
	upgradekeeper "github.com/exfury/grbchain/libs/cosmos-sdk/x/upgrade"
	upgradetypes "github.com/exfury/grbchain/libs/cosmos-sdk/x/upgrade"
	...
	//upgradeclient "github.com/exfury/grbchain/libs/cosmos-sdk/x/upgrade/client"
	"github.com/exfury/grbchain/libs/ibc-go/modules/apps/transfer"
	...
	ibckeeper "github.com/exfury/grbchain/libs/ibc-go/modules/core/keeper"
	tmproto "github.com/exfury/grbchain/libs/tendermint/abci/types"
	"github.com/exfury/grbchain/libs/tendermint/crypto"
	"github.com/exfury/grbchain/libs/tendermint/crypto/ed25519"
	"github.com/exfury/grbchain/libs/tendermint/libs/log"
	"github.com/exfury/grbchain/libs/tendermint/libs/rand"
	dbm "github.com/exfury/grbchain/libs/tm-db"
	"github.com/exfury/grbchain/x/distribution"
	distrclient "github.com/exfury/grbchain/x/distribution/client"
	distributionkeeper "github.com/exfury/grbchain/x/distribution/keeper"
	distributiontypes "github.com/exfury/grbchain/x/distribution/types"
	"github.com/exfury/grbchain/x/gov"
	govkeeper "github.com/exfury/grbchain/x/gov/keeper"
	govtypes "github.com/exfury/grbchain/x/gov/types"
	"github.com/exfury/grbchain/x/params"
	paramproposal "github.com/exfury/grbchain/x/params"
	paramskeeper "github.com/exfury/grbchain/x/params"
	paramstypes "github.com/exfury/grbchain/x/params"
	paramsclient "github.com/exfury/grbchain/x/params/client"
	stakingkeeper "github.com/exfury/grbchain/x/staking/keeper"
	stakingtypes "github.com/exfury/grbchain/x/staking/types"
	"github.com/exfury/grbchain/x/wasm/keeper/wasmtesting"
...
func createTestInput(
	...
	// https://github.com/exfury/grbchain/blob/v0.1.0/libs/cosmos-sdk/x/distribution/keeper/keeper_test.go#L50-L57
