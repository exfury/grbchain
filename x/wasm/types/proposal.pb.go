...
import (
	...
	github_com_cosmos_cosmos_sdk_types "github.com/exfury/grbchain/libs/cosmos-sdk/types"
	types "github.com/exfury/grbchain/libs/cosmos-sdk/types"
)
...
type InstantiateContractProposal struct {
	...
	Funds github_com_cosmos_cosmos_sdk_types.CoinAdapters `protobuf:"bytes,8,rep,name=funds,proto3,castrepeated=github.com/exfury/grbchain/libs/cosmos-sdk/types.Coins" json:"funds"`
}
...
type ExecuteContractProposal struct {
	...
	// Funds coins that are transferred to the contract on instantiation
	Funds github_com_cosmos_cosmos_sdk_types.CoinAdapters `protobuf:"bytes,6,rep,name=funds,proto3,castrepeated=github.com/exfury/grbchain/libs/cosmos-sdk/types.Coins" json:"funds"`
}
